class GroceryList
  ...
  def initialize(item_name, item_quantity)
    ...
    @item_price_after_discount = item_price_after_discount_check
    @item_price_before_discount = item_price_before_discount_check
  end

  def item_price_after_discount_check
    case @item_name
    when "milk"
      sale_on_quantity = 2
  ...
  def item_price_before_discount_check
    return @items_details[@item_name]["unit_price"] * @item_quantity
  end
